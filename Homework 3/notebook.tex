...
\makeatother
    ...
    \hypertarget{knn-workbook-for-cs145-homework-3}{%
\section{KNN Workbook for CS145 Homework
3}\label{knn-workbook-for-cs145-homework-3}}

\begin{longtable}[]{@{}l@{}}
\toprule
\endhead
\begin{minipage}[t]{0.07\columnwidth}\raggedright
{\textbf{PRINT YOUR NAME AND UID HERE!}}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.07\columnwidth}\raggedright
NAME: {[}Anisetti, Rajiv{]} UID: {[}904801422{]}\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np} \PY{c+c1}{\PYZsh{} for doing most of our calculations}
        \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}\PY{c+c1}{\PYZsh{} for plotting}
        \PY{k+kn}{from} \PY{n+nn}{cs145}\PY{n+nn}{.}\PY{n+nn}{data\PYZus{}utils} \PY{k}{import} \PY{n}{load\PYZus{}CIFAR10} \PY{c+c1}{\PYZsh{} function to load the CIFAR\PYZhy{}10 dataset.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{c+c1}{\PYZsh{} Set the path to the CIFAR\PYZhy{}10 data}
         \PY{n}{cifar10\PYZus{}dir} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./cs145/datasets/cifar\PYZhy{}10\PYZhy{}batches\PYZhy{}py}\PY{l+s+s1}{\PYZsq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{\PYZsh{} Subsample the data for more efficient code execution in this exercise}
...
hyperparameters via k-fold cross-validation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Import the KNN class}
        \PY{k+kn}{from} \PY{n+nn}{lib} \PY{k}{import} \PY{n}{KNN}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} Declare an instance of the knn class.}
...
\def\labelenumi{(\arabic{enumi})}
\item
  The knn.train() method simply assigns the assigns the X\_train and
  Y\_train variables to the parameters accepted by the function. This
  makes sense, as KNN is a lazy learning algorithm, and so there is no
  true training process, and our training dataset is heavily referenced
  during the prediction process.
\item
  Because there is no true training process, the cost of learning is
  reduced, but the prediction time is greatly increased as a result. In
  addition, the elmination of a singular hypothesis, as used in eager
  learning methods, is a positive for KNN as well. Because the algorithm
  does not commit to a singular function/hypothesis from a learned data
  set, we have a richer hypothesis space that can use many local linear
  functions that can form an implicit global approximation.
\end{enumerate}
...
information, predict the class of the KNN.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} Implement the function compute\PYZus{}distances() in the KNN class.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Time to run code: 55.73584222793579
...
code by vectorizing it, removing the for loops.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} Implement the function compute\PYZus{}L2\PYZus{}distances\PYZus{}vectorized() in the KNN class.}
...
predict the test point labels.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Implement the function predict\PYZus{}labels in the KNN class.}
         ...
         \PY{c+c1}{\PYZsh{} ================================================================ \PYZsh{}}
         \PY{n}{predictedLabels} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists\PYZus{}L2\PYZus{}vectorized}\PY{p}{,} \PY{n}{k} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{num\PYZus{}samples} \PY{o}{=} \PY{n}{predictedLabels}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         \PY{n}{count} \PY{o}{=} \PY{l+m+mi}{0}
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}samples}\PY{p}{)}\PY{p}{:}
             \PY{n}{count} \PY{o}{+}\PY{o}{=} \PY{p}{(}\PY{n}{predictedLabels}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{!=} \PY{n}{y\PYZus{}test}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
...
k-fold cross validation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{c+c1}{\PYZsh{} Create the dataset folds for cross\PYZhy{}valdiation.}
         ...
         \PY{n}{num\PYZus{}per\PYZus{}fold} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{num\PYZus{}training\PYZus{}examples} \PY{o}{/} \PY{n}{num\PYZus{}folds}\PY{p}{)}
         \PY{n}{randomizedIndices} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{random}\PY{o}{.}\PY{n}{permutation}\PY{p}{(}\PY{n}{num\PYZus{}training\PYZus{}examples}\PY{p}{)}
         \PY{n}{X\PYZus{}train\PYZus{}folds} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{n}{randomizedIndices}\PY{p}{]}\PY{p}{,} \PY{n}{num\PYZus{}folds}\PY{p}{)}
         \PY{n}{y\PYZus{}train\PYZus{}folds} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{[}\PY{n}{randomizedIndices}\PY{p}{]}\PY{p}{,} \PY{n}{num\PYZus{}folds}\PY{p}{)}
...
assess which one has the lowest k-fold cross validation error.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{n}{time\PYZus{}start} \PY{o}{=}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{results} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{ks}\PY{p}{)}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Your implementation}
         \PY{n}{myKNN} \PY{o}{=} \PY{n}{KNN}\PY{p}{(}\PY{p}{)}
         \PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{ks}\PY{p}{)}\PY{p}{:}
             \PY{n}{kError} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
                 \PY{n}{x\PYZus{}folds} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{[}\PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{fold}\PY{p}{]} \PY{k}{for} \PY{n}{fold} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)} \PY{k}{if} \PY{n}{fold} \PY{o}{!=} \PY{n}{j}\PY{p}{]}\PY{p}{)}
                 \PY{n}{y\PYZus{}folds} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{[}\PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{fold}\PY{p}{]} \PY{k}{for} \PY{n}{fold} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)} \PY{k}{if} \PY{n}{fold} \PY{o}{!=} \PY{n}{j}\PY{p}{]}\PY{p}{)}
                 ...
                 \PY{n}{myKNN}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{x\PYZus{}folds}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{y\PYZus{}folds}\PY{p}{)}
                 \PY{n}{distances} \PY{o}{=} \PY{n}{myKNN}\PY{o}{.}\PY{n}{compute\PYZus{}L2\PYZus{}distances\PYZus{}vectorized}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{x\PYZus{}test\PYZus{}fold}\PY{p}{)}
                 \PY{n}{pred} \PY{o}{=} \PY{n}{myKNN}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{distances}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{n}{k}\PY{p}{)}
                 \PY{n}{num\PYZus{}incorrect} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{pred} \PY{o}{!=} \PY{n}{y\PYZus{}test\PYZus{}fold}\PY{p}{)}
                 \PY{n}{kError} \PY{o}{+}\PY{o}{=} \PY{n}{num\PYZus{}incorrect} \PY{o}{/} \PY{n}{y\PYZus{}test\PYZus{}fold}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             
             \PY{n}{results}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{kError} \PY{o}{/} \PY{n}{num\PYZus{}folds}
                 
         
         \PY{n}{ks\PYZus{}min} \PY{o}{=} \PY{n}{ks}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{argsort}\PY{p}{(}\PY{n}{results}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}
         \PY{n}{results\PYZus{}min} \PY{o}{=} \PY{n+nb}{min}\PY{p}{(}\PY{n}{results}\PY{p}{)}
         ...
         \PY{c+c1}{\PYZsh{} Plot of k vs. cross\PYZhy{}validation error}
         \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{ks}\PY{p}{,}\PY{n}{results}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Set k = 10 and get minimum error as 0.7238
...
evaluate the testing error of the k-nearest neighbors model.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{n}{error} \PY{o}{=} \PY{l+m+mi}{1}
         ...
         \PY{n}{knn}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{y\PYZus{}train}\PY{p}{)}
         \PY{n}{dists\PYZus{}L2\PYZus{}vectorized} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{compute\PYZus{}L2\PYZus{}distances\PYZus{}vectorized}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{X\PYZus{}test}\PY{p}{)}
         \PY{n}{predictedLabels} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists\PYZus{}L2\PYZus{}vectorized}\PY{p}{,} \PY{n}{k} \PY{o}{=} \PY{l+m+mi}{10}\PY{p}{)}
         \PY{n}{num\PYZus{}samples} \PY{o}{=} \PY{n}{predictedLabels}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         \PY{n}{count} \PY{o}{=} \PY{l+m+mi}{0}
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}samples}\PY{p}{)}\PY{p}{:}
             \PY{k}{if} \PY{n}{predictedLabels}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{!=} \PY{n}{y\PYZus{}test}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{:}
